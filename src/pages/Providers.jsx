  ...
  return (
    <div className="p-8 bg-background min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Manage service provider accounts</p>
      </div>
              ...
              <table className="w-full">
                <thead className="bg-muted border-b border-border">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Business Type</th>
                  ...
                  {providers.length === 0 ? (
                    ...
                    providers.map((provider) => (
                      <tr key={provider.id} className="hover:bg-muted/50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-sm text-foreground">
                          TZS {parseFloat(provider.total_revenue || 0).toLocaleString()}
                        </td>
                        <td className="px-6 py-4">
